  ...
  return (
    <div className="grid min-h-80 place-items-center p-5 sm:p-8 lg:p-10">
      <div className="max-w-md text-center">
        <h1 className="text-2xl font-semibold text-white">Unable to load this page</h1>
        <p className="mt-3 text-sm leading-6 text-slate-400">Please try again. No changes have been made.</p>
