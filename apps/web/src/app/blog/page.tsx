...
export const metadata: Metadata = { title: "Blog", description: "Embedded systems tutorials, engineering notes, and practical MicroHelp articles.", alternates: { canonical: "/blog" } };
